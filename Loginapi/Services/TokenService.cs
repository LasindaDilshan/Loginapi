...
namespace Loginapi.Services
{
    public class TokenService
    {
        public static string CreateAccessToken( int id , string accessKey)
        {
            ...
            JwtSecurityToken? token = new (claims: claims,notBefore: DateTime.Now, expires: DateTime.Now.AddSeconds(30),signingCredentials:cred);
        ...
        public static string CreateRefreshToken(int id, string refreshKey)
        {
            ...
            SigningCredentials? cred = new(key, SecurityAlgorithms.HmacSha256);
            JwtSecurityToken? token = new(claims: claims, notBefore: DateTime.Now, expires: DateTime.Now.AddDays(7), signingCredentials: cred);
